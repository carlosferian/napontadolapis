...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://napontadolapis.com.br/dividir',
    locale: 'pt_BR',
    type: 'website',
  },
  alternates: { canonical: 'https://napontadolapis.com.br/dividir' },
}
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-brand-muted text-sm leading-relaxed">
          ...
          e adicione os nomes de quem vai pagar. O app Na Ponta do Lápis, em desenvolvimento
