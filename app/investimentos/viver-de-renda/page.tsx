    ...
    <div className="space-y-6">
      ...
      <div className="prose prose-sm prose-stone max-w-none space-y-4">
        ...
        <ul className="text-stone-500 dark:text-stone-400 text-sm list-disc pl-5 space-y-1">
          <li>
            <strong>Retirada Perpétua (Renda Infinita):</strong> Ocorre quando o valor que você retira mensalmente é <strong>menor ou igual aos juros gerados</strong> pelo capital no mesmo período. Dessa forma, seu patrimônio líquido nunca encolhe — pelo contrário, continua crescendo ou se mantendo estável, protegendo-se da inflação e acumulando herança perpétua.
          </li>
          <li>
        ...
        <p className="text-stone-500 dark:text-stone-400 text-sm leading-relaxed">
          <strong>Dica de Ouro (A Regra dos 4%):</strong> Desenvolvida no estudo acadêmico americano <em>Trinity Study</em>, a regra sugere que retirar anualmente 4% do patrimônio acumulado inicial (corrigido pela inflação) dá uma probabilidade de mais de 95% do patrimônio durar por pelo menos 30 anos sem zerar, mesmo sob fortes crises de mercado.
        </p>
      </div>
